# Alexa
 ...
 - say "$ alexa $ joke $" for a joke ['$' - refers to any random shit like hey, hello,..]
 - say "$ alexa $ time $" for current time
 - say "alexa who is <person_name>" for knowing about a person from a wikipedia source
 - say "$ alexa $ join class $" for joining on-going class in ms teams
